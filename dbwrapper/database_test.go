...
func newTestLDB() (*dbwrapper.LDBDatabase, func()) {
	...
	db, err := dbwrapper.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(dbwrapper.NewMemDatabase(), t)
}

func testPutGet(db dbwrapper.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(dbwrapper.NewMemDatabase(), t)
}

func testParallelPutGet(db dbwrapper.Database, t *testing.T) {
	const n = 8
