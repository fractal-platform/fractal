...
func (rw *rlpxFrameRW) WriteMsg(msg Msg) error {
	...
	if fsize > maxUint28 {
		return errors.New("message size overflows uint28")
	}
	binary.BigEndian.PutUint32(headbuf[:4], fsize)
