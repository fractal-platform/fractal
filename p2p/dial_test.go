...
func (t fakeTable) AddBlack(target *discover.Node)           {}
func (t fakeTable) RemoveBlack(target *discover.Node)        {}
...
func (t *resolveMock) AddBlack(target *discover.Node)           {}
func (t *resolveMock) RemoveBlack(target *discover.Node)        {}
